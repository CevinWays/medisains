...
class FragmentNewContentPage extends StatefulWidget {
  @override
  _FragmentNewContentPageState createState() => _FragmentNewContentPageState();
}

class _FragmentNewContentPageState extends State<FragmentNewContentPage> {
      ...
      listener: (context, state) {
        if (state is CreateContentState) {
          ...
          Fluttertoast.showToast(
              ...
              msg:
                  "Sukses menambahkan content, Silahkan Ke halaman My Content");
          ...
          builder: (context, state) {
            return Container(
              ...
              child: FlatButton(
                padding: EdgeInsets.all(16),
                onPressed: () =>
                    state is LoadingState ? null : _createContent(),
                color:
