      ...
      child: ListView(
        children: <Widget>[
          ...
          ListTile(
            ...
            title: Text("Email"),
            trailing: Text(
                App().sharedPreferences.getString("email") != null
          ...
          ListTile(
            ...
            trailing: Text(
                state is ReadUserDataState && state.userModel.education != null
                    ? state.userModel.education
                    : "Belum ada data",
                style: TextStyle(fontWeight: FontWeight.bold)),
          ),
          ListTile(
            ...
            title: Text("Gender"),
            trailing: Text(
                state is ReadUserDataState && state.userModel.gender != null
          ...
          ListTile(
            leading:
                Icon(Icons.work_outline_rounded, color: Colors.amberAccent),
            title: Text("Instansi"),
            trailing: Text(
                state is ReadUserDataState && state.userModel.instansi != null
                    ? state.userModel.instansi
                    : "Belum ada data",
                style: TextStyle(fontWeight: FontWeight.bold)),
          ),
          ListTile(
            ...
            title: Text("Location"),
            trailing: Text(
                state is ReadUserDataState && state.userModel.location != null
          ...
          ListTile(
            ...
            title: Text("No Hp"),
            trailing: Text(
              state is ReadUserDataState && state.userModel.noHp != null
                  ? state.userModel.noHp
                  : "Belum ada data",
              style: TextStyle(fontWeight: FontWeight.bold),
            ),
          )
