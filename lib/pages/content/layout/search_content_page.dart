...
class _SearchContentPageState extends State<SearchContentPage> {
              ...
              children: [
                Row(
                  children: [
                    InkWell(
                      onTap: (){
                        _contentBloc.add(SearchContentEvent(searchText: "Darah"));
                      },
                      child: Container(
                      ...
                      onTap: (){
                        _contentBloc.add(SearchContentEvent(searchText: "Kulit"));
                      },
                      child: Container(
                        margin: EdgeInsets.symmetric(horizontal: 4),
                        child: Text("Kulit"),
                      ...
                      onTap: (){
                        _contentBloc.add(SearchContentEvent(searchText: "Mental"));
                      },
                      child: Container(
                        margin: EdgeInsets.symmetric(horizontal: 4),
                        child: Text("Mental"),
                      ...
                      onTap: (){
                        _contentBloc.add(SearchContentEvent(searchText: "Gangguan"));
                      },
                      child: Container(
                        margin: EdgeInsets.symmetric(horizontal: 4),
                        child: Text("Gangguan"),
                      ...
                      onTap: (){
                        _contentBloc.add(SearchContentEvent(searchText: "Genetik"));
                      },
                      child: Container(
                        margin: EdgeInsets.symmetric(horizontal: 4),
                        child: Text("Genetik"),
                ...
                Row(
                  children: [
                    InkWell(
                      onTap: (){
                        _contentBloc.add(SearchContentEvent(searchText: "Bayi"));
                      },
                      child: Container(
                        margin: EdgeInsets.symmetric(horizontal: 4),
                        child: Text("Bayi"),
                      ...
                      onTap: (){
                        _contentBloc.add(SearchContentEvent(searchText: "Usia"));
                      },
                      child: Container(
                        margin: EdgeInsets.symmetric(horizontal: 4),
                        child: Text("Usia"),
                      ...
                      onTap: (){
                        _contentBloc.add(SearchContentEvent(searchText: "Sakit"));
                      },
                      child: Container(
                        margin: EdgeInsets.symmetric(horizontal: 4),
                        child: Text("Sakit"),
                      ...
                      onTap: (){
                        _contentBloc.add(SearchContentEvent(searchText: "Fungsi"));
                      },
                      child: Container(
                        margin: EdgeInsets.symmetric(horizontal: 4),
                        child: Text("Fungsi"),
                    ...
                    InkWell(
                      onTap: (){
                        _contentBloc.add(SearchContentEvent(searchText: "Obat"));
                      },
                      child: Container(
                        margin: EdgeInsets.symmetric(horizontal: 4),
                        child: Text("Obat"),
                ...
                Container(
                  ...
                  child: Text("Common Article", textAlign: TextAlign.start, style: TextStyle(fontWeight: FontWeight.bold,fontSize: 18),),
                ),
                _widgetCommon(),
                SizedBox(height: 16,),
                Container(
                  width: MediaQuery.of(context).size.width,
                  margin: EdgeInsets.only(top: 16,bottom: 16),
                  child: Text("Unusual Article", textAlign: TextAlign.start, style: TextStyle(fontWeight: FontWeight.bold,fontSize: 18),),
                ),
                _widgetUnusual(),
              ],
            ),
  ...
  Widget _widgetCommon(){
    return BlocBuilder(
        cubit: _contentBloc,
        builder: (context,state){
          return state is CommonDataState && state.listCommon.length > 0 ? ListView.builder(
            physics: NeverScrollableScrollPhysics(),
            shrinkWrap: true,
            itemCount: state is CommonDataState && state.listCommon.length > 0 ? state.listCommon.length : null,
            itemBuilder: (context,int index){
              ContentModel contentModel = state is CommonDataState && state.listCommon.length > 0 ? state.listCommon[index] : null;
              return InkWell(
                onTap: () {
                  Navigator.pushNamed(context, contentPage, arguments: contentModel);
                },
  ...
  Widget _widgetUnusual(){
    return BlocBuilder(
        cubit: _contentBloc,
        builder: (context,state){
          return state is CommonDataState && state.listUnusual.length > 0 ? ListView.builder(
            physics: NeverScrollableScrollPhysics(),
            shrinkWrap: true,
            itemCount: state is CommonDataState && state.listUnusual.length > 0 ? state.listUnusual.length : null,
            itemBuilder: (context,int index){
              ContentModel contentModel = state is CommonDataState && state.listUnusual.length > 0 ? state.listUnusual[index] : null;
              return InkWell(
                onTap: () {
                  Navigator.pushNamed(context, contentPage, arguments: contentModel);
                },
