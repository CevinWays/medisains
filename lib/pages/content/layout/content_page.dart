...
class _ContentPageState extends State<ContentPage> {
            ...
            child: Column(
              ...
              children: <Widget>[
                Container(
                  ...
                  child: Text(
                      widget.contentModel.category, style: TextStyle(fontSize: 14,fontWeight: FontWeight.w500,color: Colors.white)
                  ),
                ...
                Container(
                  child: Text(
                      widget.contentModel.title, style: TextStyle(fontSize: 22,fontWeight: FontWeight.bold),
                  ),
                ),
                SizedBox(height: 8,),
                Container(
                  child: Text(
                    "ISSN / eISSN: 0125-9695 / 2338-3453", style: TextStyle(fontSize: 12,color: Colors.grey),
                  ),
                ),
                SizedBox(height: 16,),
                Card(
                        ...
                        children: [
                          Column(
                            children: [
                              ...
                              Text(widget.contentModel.authorName,style: TextStyle(color: Colors.grey,fontSize: 12,fontWeight: FontWeight.bold)),
                            ],
                          ),
                          VerticalDivider(
                            width: 5,
                          ...
                          Column(
                            children: [
                              ...
                              Text(double.parse(widget.contentModel.rating).toString(),style: TextStyle(color: Colors.grey,fontSize: 12,fontWeight: FontWeight.bold)),
                            ],
                          ),
                          VerticalDivider(
                            width: 5,
                          ...
                          Column(
                            children: [
                              Icon(Icons.date_range_rounded,color: blueColor,),
                              Text(DateTimeHelper.dateTimeFormatFromString(widget.contentModel.createDate),style: TextStyle(color: Colors.grey,fontSize: 12,fontWeight: FontWeight.bold)),
                            ],
                          ),
                        ],
                      ),
                ...
                Container(
                  ...
                  child: Text("Abstrak", textAlign: TextAlign.start, style: TextStyle(fontWeight: FontWeight.bold,fontSize: 16),),
                ),
                Container(
                  width: MediaQuery.of(context).size.width,
                  child: Text(
                      widget.contentModel.desc,style: TextStyle(fontWeight: FontWeight.w400),
                  ),
                ),
                SizedBox(height: 8,),
                Row(
                      ...
                      child: Container(
                        child: FlatButton(
                          ...
                          shape: RoundedRectangleBorder(
                              borderRadius: BorderRadius.circular(8), side: BorderSide(color: primaryColor)),
                        ),
                      ),
                    ),
                    SizedBox(width: 8,),
                    Expanded(
                      child: Container(
                        child: FlatButton(
                          ...
                          shape: RoundedRectangleBorder(
                              borderRadius: BorderRadius.circular(8),side: BorderSide(color: blueColor)),
                        ),
                      ),
                    ),
                  ],
                ...
                Container(
                  width: MediaQuery.of(context).size.width,
                  margin: EdgeInsets.only(top: 16,bottom: 8),
                  child: Text("Asset", textAlign: TextAlign.start, style: TextStyle(fontWeight: FontWeight.bold,fontSize: 16),),
                ),
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    InkWell(
                      onTap: () async {
                        widget.contentModel.docUrl != null
                            && widget.contentModel.docUrl != "" ? await _launchURL() : Fluttertoast.showToast(msg: "Belum ada dokumen");
                      },
                      child: Column(
                        children: <Widget>[
                          Container(
                            ...
                            child: Column(
                              children: [
                                Icon(Icons.description_outlined,color: primaryColor,size: 30,),
                                Text("Preview",style: TextStyle(fontWeight: FontWeight.w300,color: Colors.grey,fontSize: 12))
                              ],
                            ),
                          ),
                        ],
                    ...
                    InkWell(
                      onTap: () {
                        widget.contentModel.docUrl != null
                            && widget.contentModel.docUrl != "" ? _openImage() : Fluttertoast.showToast(msg: "Belum ada dokumen");
                      },
                      child: Column(
                        children: <Widget>[
                          Container(
                            ...
                            child: Column(
                              children: [
                                Icon(Icons.image_outlined,color: primaryColor,size: 30,),
                                Text("Preview",style: TextStyle(fontWeight: FontWeight.w300,color: Colors.grey,fontSize: 12))
                              ],
                            ),
                          ),
                    ...
                    InkWell(
                      onTap: () => Fluttertoast.showToast(msg: "Belum tersedia"),
                      child: Column(
                        children: <Widget>[
                          Container(
                            padding: EdgeInsets.only(top: 16,left: 16,right: 16,bottom: 16),
                            ...
                            child: Column(
                              children: [
                                Icon(Icons.video_collection_outlined,color: primaryColor,size: 30,),
                                Text("Preview",style: TextStyle(fontWeight: FontWeight.w300,color: Colors.grey,fontSize: 12))
                              ],
                            ),
                          ),
      ...
      builder: (context) => AlertDialog(
        ...
        actions: <Widget>[
          FlatButton(
            ...
            child: Text('Tutup', style: TextStyle(fontSize: 18.0, color: Colors.white)),
          )
        ],
      ),
    );
  ...
  _copyReference(BuildContext context) {
    showDialog(
      context: context,
      builder: (context) => AlertDialog(
        content: Container(child: SelectableText(
            widget.contentModel.authorName+"."+widget.contentModel.title+"."+widget.contentModel.createDate,
          cursorWidth: 2,
          showCursor: true,
  ...
  Future<void> _share() async{
    await Share.share(
        widget.contentModel.desc, subject: widget.contentModel.title
    );
  }
}
